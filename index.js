...
const rest = new REST({ version: "10" }).setToken("MTI3MzQ0MTM4Mjc0ODUyNDYwOA.GxvqEV.j7OlIIf25DV-J0ynyXXY6wK8P8aYWcSKAIt6R4");

createSlash();

async function createSlash() {
  try {
    await rest.put(Routes.applicationCommands("1273441382748524608"), {
      body: commands,
    });
